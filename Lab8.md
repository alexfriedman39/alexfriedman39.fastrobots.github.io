...
The graphs shown below display both the robot's distance from the wall and its motor's PWM value over time. The plots correspond to flips 1 and 2, respectively. 

*** ADD IN EXPLANATION OF WHAT GRAPHS SHOW ***
